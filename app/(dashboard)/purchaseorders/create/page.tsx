        ...
        if (!found) {
            ...
            try {
                const { data } = await api.get<SkuData>(
                    `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/webproduct/skudetailsforpurchaseorder?sku=${selectedSku}`,
                    { httpsAgent }
                );
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                {details.country === 'Australia' ? (
                    <FormControl fullWidth margin="dense">
                        <InputLabel>Supplier State</InputLabel>
                        <Select
                            value={details.state}
                    ...
                    <TextField
                        label="Supplier State / Province / Region"
                        fullWidth
                        margin="dense"
                        value={details.state}
                        onChange={(e) => handleChange('state', e.target.value)}
            ...
            <Box sx={{
                ...
                <Typography variant="h6">Purchase Order Lines</Typography>
